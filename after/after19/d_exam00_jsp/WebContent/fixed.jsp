...
<body>
	...
	<main id="section">
		<h3 class="title">학생성적확인 및 수정/입력/삭제</h3>
		<table class="table_line">
			...
			<tr align="center">
				...
				<td>
					<button type="button" onclick="location.href='update.jsp?sno=<%= rs.getString(1) %>'">수정/입력</button>
					<button type="button" onclick="return Delete(<%= rs.getString(1) %>)">삭제</button>
					<button type="button" onclick="location.href='z_inquiery.jsp?sno=<%= rs.getString(1) %>'">조회</button>
				</td>
			</tr>
			<%
			}
