    ...
    <main id="section">
        <h3 class="title">회원목록조회/수정</h3>
       	...
       	<table class="table_line">
            ...
            <% while(rs.next()) { %>
            <tr align="center">
                <td class="link"><a style="color : blue" href="update.jsp?custno=<%= rs.getString("custno") %>"><%= rs.getString("custno") %></a></td>
				...
				<td>
                    ...
                    <input type="button" value="조회" onclick="document.location.href='z_input_p.jsp?custno=<%= rs.getString("custno") %>'">
                </td>
            </tr>
            <% } %>
        </table>
