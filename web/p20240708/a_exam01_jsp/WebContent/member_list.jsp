    ...
    <main id="section">
    	...
    	<div class="scroll">
    		<table class="table_line">
    			...
    			<tr align="center">
    				<td class="link">
    				<a style="color:blue" href="update.jsp?custno=<%= rs.getString("custno") %>">
    				...
    				<td>
    					<input type="button" value="수정" onclick="document.location.href='update.jsp'">
    					<input type="button" value="삭제" onclick="check_del(<%= rs.getString("custno") %>);">
    					<input type="button" value="조회" onclick="document.location.href='z_input_inquiry.jsp?custno=<%= rs.getString("custno") %>'">
    				</td>
    			</tr>
    		<% } %>
    		</table>
