 ...
 * Generated at: 2024-05-14 00:11:34 UTC
...
public final class section_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t<h2 class=\"title\">쇼핑몰 회원관리 프로그램</h2>\r\n");
      out.write("\t\t<p>\r\n");
      out.write("\t\t\t쇼핑몰회원관리 프로그램이다.<br>\r\n");
      out.write("\t\t\t프로그램 작성 순서<br>\r\n");
      out.write("\t\t\t1. 회원정보 테이블을 생성한다.<br>\r\n");
      out.write("\t\t\t2. 매출정보 테이블을 생성한다.<br>\r\n");
      out.write("\t\t\t3. 회원정보, 매출정보 테이블에서 제시된 문제지의 참조데이터를 추가 생성한다.<br>\r\n");
      out.write("\t\t\t4. 회원정보 입력 화면프로그램을 작성한다.<br>\r\n");
      out.write("\t\t\t5. 회원정보 조회 프로그램을 작성한다.<br>\r\n");
      out.write("\t\t\t6. 회원매출정보 조회 프로그램을 작성한다.<br>\r\n");
      out.write("\t\t</p>\r\n");
      out.write("\t</main>\r\n");
      out.write("</body>\r\n");
      out.write("</html>");
